                            ...
                            <div class="ch-article-content">
                                <form id="user_form" class="ch-form" action="<?php echo $user['action']?>" method="POST">
                                    <table>
                                        ...
                                        <tr>
                                            <td><label>Fakultas / Prodi :</label></td>
                                            <td><input type="text" name="mhs_fak_prod" value="<?php echo $user['m_f_p']?>" data-provide="typeahead" autocomplete="off" data-items="4" data-source='[<?php echo implode(",",$fpl)?>]' placeholder="fakultas / prodi"></td>
                                        </tr>
                                        <tr>
                                            <td><label>Angkatan :</label></td>
                                            <td><input type="text" name="mhs_angkatan" value="<?php echo $user['m_ang']?>" placeholder="tahun angkatan"></td>
                                        </tr>
                                        <tr>
                                            <td><label>Program :</label></td>
                                            <td><input type="text" name="mhs_program" value="<?php echo $user['m_pro']?>" placeholder="program" data-provide="typeahead" autocomplete="off" data-items="4" data-source='["reguler","ekstensi"]'></td>
                                        </tr>
                                        <tr>
